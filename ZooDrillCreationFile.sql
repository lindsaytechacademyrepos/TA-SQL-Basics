...
CREATE PROCEDURE createZooTables
AS
...
GO
CREATE PROCEDURE insertIntoZooTables
AS
...
DROP TABLE tbl_care;
DROP TABLE tbl_nutrition;
DROP TABLE tbl_habitat;
DROP TABLE tbl_specialist;
GO


EXEC createZooTables
EXEC insertIntoZooTables;
GO

EXEC dropAllTables;
GO

DROP PROCEDURE createZooTables;
DROP PROCEDURE insertIntoZooTables;
